...
const cronJobs = [
  ...
  { title: 'MARC-OS Surprise', desc: 'Design a surprise feature for MARC OS. Delegate build to Pixel/Anvil sub-agent.', time: '4:00 AM WET', duration: '~15-20 min', tag: 'LAB', tagColor: 'text-green-400 border-green-900/50 bg-green-900/20', actions: ['Feature design', 'Build (delegated)'] },
  { title: 'MARC-OS Self-Improvement', desc: 'Identify and design improvements for MARC OS. Delegate build to engineering sub-agent.', time: '4:30 AM WET', duration: '~15-20 min', tag: 'LAB', tagColor: 'text-green-400 border-green-900/50 bg-green-900/20', actions: ['Improvement design', 'Build (delegated)'] },
