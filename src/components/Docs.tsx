  ...
  return (
    <div className="flex h-full gap-6">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-3xl font-bold mb-6">InstaDesk HQ Overview</h1>
        <p className="text-gray-300 mb-4 leading-relaxed">
          InstaDesk HQ is an internal AI operations dashboard built to manage a team of autonomous agents. 
